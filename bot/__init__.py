...
if len(AUTHOR_URL) == 0:
    AUTHOR_URL = 'https://t.me/botupquadrive'
...
if len(UPSTREAM_REPO) == 0:
   UPSTREAM_REPO = 'https://github.com/yeuboth/WZML'
